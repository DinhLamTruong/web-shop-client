              ...
              <tr className="text-center" key={index}>
                <td className="pl-0 border-0">
                  <div className="media align-items-center justify-content-center">
                    <Link
                      ...
                      to={`/detail/${value._doc?.productId._id}`}
                    >
                      <img
                        src={value._doc?.productId.img1}
                        alt="..."
                        width="70"
                      />
                    </Link>
                ...
                <td className="align-middle border-0">
                  <p className="mb-0 small">
                    {convertMoney(value._doc?.productId.price)} VND
                  </p>
                </td>
                <td className="align-middle border-0">
                ...
                <td className="align-middle border-0">
                  <p className="mb-0 small">
                    {convertMoney(
                      parseInt(value._doc?.productId.price) *
                        parseInt(value._doc?.quantity)
                    )}{' '}
                    VND
                  </p>
                </td>
                <td className="align-middle border-0">
                  <a
                    ...
                    style={{ cursor: 'pointer' }}
                    onClick={() =>
                      handlerDelete(value.userId._id, value._doc.productId._id)
                    }
                  >
